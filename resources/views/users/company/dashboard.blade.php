    ...
    <div class="mt-10 bg-white drop-shadow-md rounded-xl p-10 mb-10">
        ...
        <div class="mt-10 flex flex-col gap-6 mx-0 md:mx-12"> 
            ...
            <div class="bg-gray-100 drop-shadow-md rounded-xl p-6 flex items-center">
                ...
                <div class="ml-4 flex-grow flex justify-between items-center">
                    <div>
                        <div class="text-sm font-medium text-gray-500">Total de Planos Aceites</div>
                    </div>
                    <div class="text-xl font-bold text-gray-800">{{ $acceptedPlans }}</div>
                </div>
            </div>
            ...
            <div class="ml-4 flex-grow flex justify-between items-center">
                <div>
                    <div class="text-sm font-medium text-gray-500">Total de Planos Pendentes / Rejeitados</div>
                </div>
                <div class="text-xl font-bold text-gray-800">{{ $pendingPlans }}</div>
            </div>
        </div>
