...
@section('navbar-items')
    ...
    <li class="my-3 md:mb-0 md:mt-0">
        <a href="{{ url('/instituicao') }}" class="text-white md:text-sky-400 text-base font-extrabold">Instituição</a>
    </li>
    <li class="my-3 md:mb-0 md:mt-0">
    ...
    <li class="inline-block transition-transform transform hover:scale-105 duration-300 ease-in-out my-5 md:mb-0 md:mt-0">
        <a href="{{ url('/register') }}" class="bg-white md:bg-sky-400  text-base font-bold md:text-white text-sky-400 p-2 rounded-xl px-6 sm:px-6">Começar Agora</a>
    </li>
@endsection
