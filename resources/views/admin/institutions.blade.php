...
@section('content')
    <div class="mt-10 bg-white drop-shadow-md rounded-xl p-10">
        ...
        <div class="flex justify-between items-center my-5">
            <!-- Barra de pesquisa -->
            <form class="hidden sm:flex  w-auto">  
                <label for="simple-search" class="sr-only">Procurar</label>
                <div class="relative w-full">
                    <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Procurar uma Instituição..." required />
                </div>
            ...
            <button onclick="openModal()" class="bg-green-500 hover:bg-green-600 text-white font-bold rounded-xl p-2.5 flex text-sm items-center">
