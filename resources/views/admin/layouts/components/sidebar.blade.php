   ...
   <div class="flex flex-col h-full px-3 py-10 overflow-y-auto">
      ...
      <div id="navbar-default" class="flex-grow px-2"> 
         <ul class="space-y-4">
            <!-- Home -->
            <li>
               <a href="{{ url('/admin') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400 group">
            ...
            <!-- Utilizadores -->
            <li>
               <a href="{{ url('/admin/users') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400 group">
            ...
            <li class="relative">
               <details class="group">
                  <summary class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400 group cursor-pointer">
                     <!-- Icon -->
                  ...
                  <ul class="ml-5 mt-2 rounded-md space-y-2">
                     <!-- Submenu para Instituições -->
                     <li>
                        <a href="{{ url('/admin/institutions/') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Instituições</span>
                        </a>
                     </li>
                     <!-- Submenu para Cursos -->
                     <li>
                        <a href="{{ url('/admin/institutions/courses') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Cursos</span>
                        </a>
                     </li>
                     <!-- Submenu para Unidades Curriculares -->
                     <li>
                        <a href="{{ url('/admin/institutions/units-curriculars') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-5 mt-2 rounded-md space-y-2">
                     ...
                     <li>
                        <a href="{{ url('/admin/coordinators/uc-responsibles') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Responsáveis U.C</span>
                        </a>
                     </li>
                     <!-- Submenu para Notificacoes -->
                     <li>
                        <a href="{{ url('/admin/coordinators/notifications') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-5 mt-2 rounded-md space-y-2">
                     <!-- Submenu para Alunos -->
                     <li>
                        <a href="{{ url('/admin/students') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Alunos </span>
                        </a>
                     </li>
                     <!-- Submenu para Notificacoes -->
                     <li>
                        <a href="{{ url('/admin/students/notifications') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Notificações</span>
                        </a>
                     </li>
                  </ul>
            ...
            <!-- Empresas -->
            <li>
               <a href="{{ url('/admin/companies') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400 group">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 24 24" class="ms-2">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-5 mt-2 rounded-md space-y-2">
                     ...
                     <li>
                        <a href="{{ url('/admin/internships/offers') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Ofertas</span>
                        </a>
                     </li>
                     <!-- Submenu para Planos de Estagio -->
                     <li>
                        <a href="{{ url('/admin/internships/plans') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Planos</span>
                        </a>
                     </li>
                     <!-- Submenu para Registo Diarios -->
                     <li>
                        <a href="{{ url('/admin/internships/attendance-records') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Registos Diários</span>
                        </a>
                     </li>
                     <!-- Submenu para Relatorios Finais -->
                     <li>
                        <a href="{{ url('/admin/internships/final-reports') }}" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-sky-400 ">
      ...
      <div id="navbar-default" class="flex flex-col px-5 justify-end h-full"> 
         <ul class="space-y-4 mt-auto"> 
            <li>
               <a href="#" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-yellow-400 group">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 24 24"  class="ms-2">
            ...
            <li>
               <a href="#" class="flex items-center p-2 text-gray-500 hover:text-white font-semibold rounded-lg hover:bg-red-400 group">
                  <svg xmlns="http://www.w3.org/2000/svg"  width="1.6em" height="1.6em" viewBox="0 0 24 24"  class="ms-2">
