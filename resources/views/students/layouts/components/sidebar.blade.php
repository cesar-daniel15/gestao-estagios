   ...
   <div class="flex flex-col h-full px-3 py-5 xl:py-10 overflow-y-auto">
      ...
      <div id="navbar-default" class="flex-grow px-2"> 
         <ul class="space-y-2 mt-5 xl:mt-10 xl:space-y-4">
            ...
            <!-- Cursos -->
            <li>
               <a href="{{ url('/student/courses') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <li>
               <a href="{{ url('/student/units-curriculars') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <!-- UC Responsável -->
            <li>
               <a href="{{ url('/student/Uc-responsibles') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <!-- Alunos -->
            <li>
               <a href="{{ url('/student/students') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
