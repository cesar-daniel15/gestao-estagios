   ...
   <div class="flex flex-col h-full px-3 py-5 xl:py-10 overflow-y-auto">
      ...
      <div id="navbar-default" class="flex-grow px-2"> 
         <ul class="space-y-2 mt-5 xl:mt-10 xl:space-y-4">
            <!-- Home -->
            <li>
               <a href="{{ url('/responsible') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <!-- Cursos -->
            <li>
               <a href="{{ url('/responsible/courses') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <li>
               <a href="{{ url('/responsible/units-curriculars') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <!-- UC Responsável -->
            <li>
               <a href="{{ url('/responsible/Uc-responsibles') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <!-- Perfil -->
            <li>
               <a href="{{ url('/responsible/auth') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
               <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 24 24"  class="ms-2">
