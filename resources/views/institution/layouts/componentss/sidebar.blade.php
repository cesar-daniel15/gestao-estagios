   ...
   <div class="flex flex-col h-full px-3 py-5 xl:py-10 overflow-y-auto">
      ...
      <div id="navbar-default" class="flex-grow px-2"> 
         <ul class="space-y-2 mt-5 xl:mt-10 xl:space-y-4">
            ...
            <!-- Utilizadores -->
            <li>
               <a href="{{ url('/institution/users') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-7 mt-2 rounded-md space-y-2">
                     ...
                     <li>
                        <a href="{{ url('/institution/institutions/') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Instituições</span>
                        </a>
                     </li>
                     <!-- Submenu para Cursos -->
                     <li>
                        <a href="{{ url('/institution/courses') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Cursos</span>
                        </a>
                     </li>
                     <!-- Submenu para Unidades Curriculares -->
                     <li>
                        <a href="{{ url('/institution/institutions/units-curriculars') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-7 mt-2 rounded-md space-y-2">
                     ...
                     <li>
                        <a href="{{ url('/institution/coordinators/uc-responsibles') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Responsáveis U.C</span>
                        </a>
                     </li>
                     <!-- Submenu para Notificacoes -->
                     <li>
                        <a href="{{ url('/institution/coordinators/notifications') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-7 mt-2 rounded-md space-y-2">
                     <!-- Submenu para Alunos -->
                     <li>
                        <a href="{{ url('/institution/students') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Alunos</span>
                        </a>
                     </li>
                     <!-- Submenu para Notificacoes -->
                     <li>
                        <a href="{{ url('/institution/students/notifications') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Notificações</span>
                        </a>
                     </li>
                  </ul>
            ...
            <!-- Empresas -->
            <li>
               <a href="{{ url('/institution/companies') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 group">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 24 24" class="ms-2">
            ...
            <li class="relative">
               <details class="group">
                  ...
                  <ul class="ml-7 mt-2 rounded-md space-y-2">
                     ...
                     <li>
                        <a href="{{ url('/institution/internships/offers') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Ofertas</span>
                        </a>
                     </li>
                     <!-- Submenu para Planos de Estagio -->
                     <li>
                        <a href="{{ url('/institution/internships/plans') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Planos</span>
                        </a>
                     </li>
                     <!-- Submenu para Registo Diarios -->
                     <li>
                        <a href="{{ url('/institution/internships/attendance-records') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400">
                           <span class="ms-5 text-sm">Registos Diários</span>
                        </a>
                     </li>
                     <!-- Submenu para Relatorios Finais -->
                     <li>
                        <a href="{{ url('/institution/internships/final-reports') }}" class="flex items-center p-2 text-gray-500 hover:text-white rounded-lg hover:bg-sky-400 ">
