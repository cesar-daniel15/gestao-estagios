...
<section>
    <div class="w-full h-auto p-10 bg-gradient-to-r from-sky-400 to-blue-600 flex flex-col justify-center items-center text-center">
        <div class="text-2xl md:text-3xl font-extrabold text-white mb-4 my-5">Responsável de Empresa</div>
        <p class="text-white max-w-2xl text-center">
            A nossa plataforma simplifica a gestão de estagiários, permitindo acompanhar o progresso, aprovar planos e avaliar o desempenho dos mesmos. Com uma interface intuitiva, facilita a comunicação com supervisores acadêmicos e centraliza toda a documentação necessária.
        </p>
    </div>
</section>
...
<section>
    <div class="w-full h-auto p-10 bg-white flex flex-col justify-center text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-100 p-4 rounded-lg">
                <div class="font-bold text-sky-400">3. Anexar Plano de Estágio</div>
            </div>

            <div class="bg-gray-100 p-4 rounded-lg">
                <div class="font-bold text-sky-400">4. Aprovar Assiduidade</div> 
            </div>
